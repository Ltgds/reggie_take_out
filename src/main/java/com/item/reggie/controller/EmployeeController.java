...
public class EmployeeController {
     ...
     */
    @PostMapping("/login")
    public Result<Employee> login(HttpServletRequest request, @RequestBody Employee employee) { //RequestBody接收json格式
